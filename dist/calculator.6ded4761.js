...
})({"gyELQ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "72ed2bac6ded4761";
...
var _fetchFoodData = require("./functions/fetchFoodData");
var _fetchFoodDataDefault = parcelHelpers.interopDefault(_fetchFoodData);
//Declare variables
let hit;
let foodTableBody;
let foodLabel;
...
window.addEventListener("load", ()=>{
    ...
    searchBarcodeBtn.addEventListener("click", (e)=>{
        ...
        (0, _fetchFoodDataDefault.default)(searchBarcode).then((data)=>{
...
},{"./functions/fetchFoodData":"lcJqW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lcJqW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
async function fetchFoodData(searchBarcode) {
    //Declare input values for API
    const RECIPE_URI = "https://api.edamam.com";
    const RECIPE_ENDPOINT = "/api/food-database/v2/parser";
    const API_ID = "17d25365";
    const API_KEY = "2cab7c493740093bdb299d3d5bc0610a";
    console.log(API_ID);
    console.log(API_KEY);
    console.log({
        searchBarcode
...
},{}]},["gyELQ","9WiAu"], "9WiAu", "parcelRequire02c0")

//# sourceMappingURL=calculator.6ded4761.js.map
